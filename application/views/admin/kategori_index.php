						...
						<div class="modal-body">
							<div class="row">
								<div class="col mb-3">
									...
									<input type="text" id="nameWithTitle" class="form-control" placeholder="Nama" name="nama_kategori" required />
								</div>
							</div>
						</div>
				...
				<tr>
					...
					<td>
						<a class="btn btn-sm btn-danger" onClick="return confirm('Apakah Anda Yakin Ingin Hapus Data Ini?')"
							href="<?php echo base_url('admin/kategori/delete_data/'.$aa['id_kategori']) ?>">
										...
										<div class="modal-body">
											<div class="row">
												<div class="col mb-3">
													...
													<input type="text" id="nameWithTitle" class="form-control" value="<?= $aa['nama_kategori'] ?>"
														name="nama_kategori" />
												</div>
											</div>
