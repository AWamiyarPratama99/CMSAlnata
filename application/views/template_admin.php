...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="<?= base_url('assets/sneat/') ?><?= base_url('assets/sneat/') ?>/assets/img/favicon/favicon.ico" />
...
<body>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item <?php if($menu=='konten'){ echo "active"; } ?> ">
            <a href="<?= site_url('admin/konten') ?>" class="menu-link">
              ...
              <div data-i18n="Analytics">Konten</div>
            </a>
          </li>
  ...
  <script>
      $('ngilang').delay('slow').delay(1000).slideUp(600);
    </script>
</body>
</html>
